                            ...
                            <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <th><a href="../funciones/funcGaseosa/ACTUALIZAR3.php?id=<?php echo $row['nombre'] ?>" class="btn btn-info">Editar</a></th>
                                            <th><a href="../funciones/funcGaseosa/DELETE3.php?id=<?php echo $row['nombre'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                        </tr>
                                    <?php 
                                        }
                                    ?>
