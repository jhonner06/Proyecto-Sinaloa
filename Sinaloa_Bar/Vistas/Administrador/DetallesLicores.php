                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <div class="col-md-3">
                            <form action="../../funciones/funcLicor/INSERTAR2.php" method="POST">
                            ...
                            <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <th><a href="../../funciones/funcLicor/ACTUALIZAR2.php?id=<?php echo $row['nombre'] ?>" class="btn btn-outline-secondary">Editar</a></th>
                                            <th><a href="../../funciones/funcLicor/DELETE2.php?id=<?php echo $row['nombre'] ?>" class="btn btn-outline-danger">Eliminar</a></th>                                        
                                        </tr>
                                    <?php 
                                        }
                                    ?>
