                            ...
                            <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <th><a href="../../funciones/funcAguaEB/ACTUALIZAR4.php?id=<?php echo $row['nombre'] ?>" class="btn btn-info">Editar</a></th>
                                            <th><a href="../../funciones/funcAguaEB/DELETE4.php?id=<?php echo $row['nombre'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                        </tr>
                                    <?php 
                                        }
                                    ?>
