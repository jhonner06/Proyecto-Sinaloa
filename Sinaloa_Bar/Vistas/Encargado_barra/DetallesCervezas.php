                            ...
                            <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <th><a href="../../funciones/funcCervezasEB/ACTUALIZAR1.php?id=<?php echo $row['nombre'] ?>" class="btn btn-outline-secondary">Editar</a></th>
                                            <th><a href="../../funciones/funcCervezasEB/DELETE1.php?id=<?php echo $row['nombre'] ?>" class="btn btn-outline-danger">Eliminar</a></th>                                        
                                        </tr>
                                    <?php 
                                        }
                                    ?>
