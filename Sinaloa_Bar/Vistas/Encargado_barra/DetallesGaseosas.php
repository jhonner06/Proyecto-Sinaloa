                            ...
                            <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <th><a href="../../funciones/funcGaseosaEB/ACTUALIZAR3.php?id=<?php echo $row['nombre'] ?>" class="btn btn-info">Editar</a></th>
                                            <th><a href="../../funciones/funcGaseosaEB/DELETE3.php?id=<?php echo $row['nombre'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                        </tr>
                                    <?php 
                                        }
                                    ?>
