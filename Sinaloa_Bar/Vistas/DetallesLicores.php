                            ...
                            <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <th><a href="../funciones/funcLicor/ACTUALIZAR2.php?id=<?php echo $row['nombre'] ?>" class="btn btn-info">Editar</a></th>
                                            <th><a href="../funciones/funcLicor/DELETE2.php?id=<?php echo $row['nombre'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                        </tr>
                                    <?php 
                                        }
                                    ?>
